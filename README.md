...
[**4.⚙️담당 서브 시스템 구현 기능**](#⚙️담당-서브-시스템-구현-기능🔝) v finish

[**5.♾️DevOps**](#♾️devops🔝) v finish

[**6.🏗️CI/CD 구성**](#🏗️cd/cd-구성🔝) v finish

[**7.💽ERD**](#💽erd🔝) v finish

[**8.📊GitBranch 전략**](#📊gitbranch-전략🔝) v finish
...
-   복사된 링크나 SNS공유로 외부인이 접근했을 때 아이디가 없음에도 접근할 수 있는 문제
-   </li>
